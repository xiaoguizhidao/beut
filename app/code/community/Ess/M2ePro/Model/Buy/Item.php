...
class Ess_M2ePro_Model_Buy_Item extends Ess_M2ePro_Model_Component_Abstract
{
    ...
    public function getAccount()
    {
        if (is_null($this->accountModel)) {
            $this->accountModel = Mage::helper('M2ePro/Component_Buy')->getObject('Account',$this->getAccountId());
        }
    ...
    public function getMarketplace()
    {
        if (is_null($this->marketplaceModel)) {
            $this->marketplaceModel = Mage::helper('M2ePro/Component_Buy')->getObject('Marketplace',
