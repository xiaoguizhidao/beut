...
class Mage_Catalog_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getBreadcrumbPath()
    {
        if (!$this->_categoryPath) {
            ...
            /* Added by S2L Solutions <info@s2lsolutions.com> -- Date added: Fri, Apr 18, 2014*/
            if($this->isAmPageCreated()){
            	$params = Mage::registry('amshopby_current_params');
            	if($params){
    ...
    /* Added by S2L Solutions <info@s2lsolutions.com> -- Date added: Fri, Apr 18, 2014*/
    public function isAmPageCreated(){
