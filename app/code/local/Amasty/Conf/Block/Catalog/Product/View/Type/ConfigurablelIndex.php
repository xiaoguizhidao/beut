 ...
 * @package Amasty_Conf
 */
class Amasty_Conf_Block_Catalog_Product_View_Type_ConfigurablelIndex extends Mage_Catalog_Block_Product_View_Type_Configurable
{
                ...
                foreach ($simpleProducts as $simple)
                {
                    ...
                    if ($key)
                    {
                        ...
                        if(!('no_selection' == $simple->getSmallImage() || '' == $simple->getSmallImage())){
                            $confData[$strKey]['small_image'] = $indexData['simples'][$simple->getId()]['small_image_url'];
