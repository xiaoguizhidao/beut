...
{
    const XML_ENABLED_IN_ORDERS = 'mageworx_customers/geolocation/enable_orders';
    const XML_ENABLED_IN_ONLINE_CUSTOMERS = 'mageworx_customers/geolocation/enable_online_customers';
    ...
    public function getGeoIpHtml($obj)
    {
        $block = Mage::app()->getLayout()
            ...
            ->setTemplate('geolocation/adminhtml-customer-geoip.phtml')
