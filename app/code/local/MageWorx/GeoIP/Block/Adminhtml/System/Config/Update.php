...
class MageWorx_GeoIP_Block_Adminhtml_System_Config_Update extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {
        $url = Mage::helper('adminhtml')->getUrl('mwgeoip/adminhtml_database/update/');
        ...
        $lastUpdate = "<br>" . Mage::helper('mwgeoip')->__('Last update') . ": ";
        if (Mage::helper('mwgeoip')->getLastUpdateTime()) {
            $lastUpdate .= Mage::helper('mwgeoip')->getLastUpdateTime();
        } else {
            $lastUpdate .= 'n/a';
        }
