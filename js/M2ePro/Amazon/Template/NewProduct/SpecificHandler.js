AmazonTemplateNewProductSpecificHandler = Class.create();
AmazonTemplateNewProductSpecificHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    renderUnrequiredSpecifics: function(specifics,container,renderCallback)
    {
        ...
        var label = labelDiv.appendChild(new Element('label',{'style': 'font-weight: bold; font-style: italic'})
                            .insert(self.M2ePro.text.add_optional_specifics + ': '));
        ...
        specifics.each(function(specific) {
            ...
            if (parseInt(specific.data_definition.evalJSON().is_desired)) {
                specificTitle += ' (' + self.M2ePro.text.desired + ')';
            }
...
//        });
    ...
    appendChooseButton: function(specific,div,container)
    {
        ...
        chooseButton.appendChild(new Element('span')).insert(M2ePro.text.choose);
    ...
    appendAddButton: function(specific,div,container)
    {
        ...
        addButton.appendChild(new Element('span')).insert(M2ePro.text.add);
    ...
    appendCloneButton: function(specific,div,container)
    {
        ...
        cloneButton.appendChild(new Element('span')).insert(M2ePro.text.clone);
    ...
    appendRemoveButton: function(specific,div,container)
    {
        ...
        removeButton.appendChild(new Element('span')).insert(M2ePro.text.delete);
...
//        });
    ...
    renderChooseMode: function(specific,container)
    {
        ...
        var temp = select.appendChild(new Element('option',{'value': 'recommended_value','style': 'display: none'})).insert(this.M2ePro.text.recommended_value);

        if (specific.recommended_values && specific.recommended_values.evalJSON().length > 0) {
            temp.show();
        }

        select.appendChild(new Element('option',{'value': 'custom_value'})).insert(this.M2ePro.text.custom_value);
        select.appendChild(new Element('option',{'value': 'custom_attribute'})).insert(this.M2ePro.text.custom_attribute);
    ...
    renderModeCustomValue: function(specific,container,contentCallback)
    {
        ...
        div.appendChild(new Element('label')).insert(this.M2ePro.text.custom_value + ': <span class="required">*</span>');
    ...
    renderModeCustomAttribute: function(specific,container)
    {
        ...
        var label = div.appendChild(new Element('label')).insert(this.M2ePro.text.custom_attribute + ': <span class="required">*</span>');
    ...
    renderModeRecommendedValue: function(specific,container)
    {
        ...
        div.appendChild(new Element('label')).insert(this.M2ePro.text.recommended_value + ': <span class="required">*</span>');
    ...
    renderAttributesModeCustomValue: function(attribute,index,specific,container)
    {
        ...
        div.appendChild(new Element('label')).insert(this.M2ePro.text.custom_value +  ': ' + (attribute.required ? '<span class="required">*</span>' : ''));
    ...
    renderAttributesModeCustomAttribute: function(attribute,index,specific,container)
    {
        ...
        var label = div.appendChild(new Element('label')).insert(this.M2ePro.text.custom_attribute + ': ' + (attribute.required ? '<span class="required">*</span>' : ''));
    ...
    {
        this.renderPopUp(container,this.M2ePro.text.allowed_values,function() {
    ...
    {
        this.renderPopUp(container,this.M2ePro.text.recommended_values,function() {
            var winContent = new Element('ul',{'style': 'text-align: center; margin-top: 10px'});
    ...
    renderHelpIconDataDefinition: function(dataDefinition,title,container) {
        ...
        this.renderPopUp(container,title + ' ' + self.M2ePro.text.helpful_info,function() {
