<?php
    ...
    class MagicToolboxCoreInstallerClass {
            ...
            foreach($lines as $num => $line) {
                ...
                switch($matches[1]) {
                    case 'CREATE':
                        switch($matches[2]) {
                            case 'FILE':
                                if(file_exists($this->dir.'/'.$matches[3])) {
                            ...
                            case 'BACKUP':
                                ...
                                if(file_exists($this->dir.'/'.$params[0])) {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.6.6' || 'working' == 'v4.0.28') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=commercial&tool_version=v4.0.28&module_version=v4.6.6&platform_name=magento&platform_version={$platformVersion}&url={$url}";
